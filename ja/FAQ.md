...
詳しくは Unity のアップデート情報などをご確認ください。

##### AppSteroid の Unityバージョンの対応状況
...
- *1 : プッシュ通知からアプリを起動した際に、該当ページが表示されない不具合があります。
- *2 : Unity にて iOS ビルド時にエラーが発生します。
- *3 : Unity にて iOS ビルド後、Xcode上でエラーが発生します。
